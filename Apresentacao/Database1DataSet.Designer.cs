...
namespace Apresentacao {
    ...
    public partial class Database1DataSet : global::System.Data.DataSet {
        ...
        public partial class FornecedorDataTable : global::System.Data.TypedTableBase<FornecedorRow> {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "17.0.0.0")]
            public FornecedorRow AddFornecedorRow(string Nome, string Email, int TipoPessoa, string Cpf_cnpj, string Razao_social, string Rua, int Numero, string Bairro, string Cidade, string Complemento, string Cep, string Telefone, string Celular) {
...
namespace Apresentacao.Database1DataSetTableAdapters {
    ...
    public partial class FornecedorTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.DeleteCommand.CommandText = @"DELETE FROM [dbo].[Fornecedor] WHERE (([Id] = @Original_Id) AND ([Nome] = @Original_Nome) AND ([Email] = @Original_Email) AND ([TipoPessoa] = @Original_TipoPessoa) AND ([Cpf_cnpj] = @Original_Cpf_cnpj) AND ([Razao_social] = @Original_Razao_social) AND ([Rua] = @Original_Rua) AND ([Numero] = @Original_Numero) AND ([Bairro] = @Original_Bairro) AND ([Cidade] = @Original_Cidade) AND ([Complemento] = @Original_Complemento) AND ([Cep] = @Original_Cep) AND ([Telefone] = @Original_Telefone) AND ([Celular] = @Original_Celular))";
            ...
            this._adapter.InsertCommand.CommandText = @"INSERT INTO [dbo].[Fornecedor] ([Nome], [Email], [TipoPessoa], [Cpf_cnpj], [Razao_social], [Rua], [Numero], [Bairro], [Cidade], [Complemento], [Cep], [Telefone], [Celular]) VALUES (@Nome, @Email, @TipoPessoa, @Cpf_cnpj, @Razao_social, @Rua, @Numero, @Bairro, @Cidade, @Complemento, @Cep, @Telefone, @Celular);
SELECT Id, Nome, Email, TipoPessoa, Cpf_cnpj, Razao_social, Rua, Numero, Bairro, Cidade, Complemento, Cep, Telefone, Celular FROM Fornecedor WHERE (Id = SCOPE_IDENTITY())";
            ...
            this._adapter.UpdateCommand.CommandText = @"UPDATE [dbo].[Fornecedor] SET [Nome] = @Nome, [Email] = @Email, [TipoPessoa] = @TipoPessoa, [Cpf_cnpj] = @Cpf_cnpj, [Razao_social] = @Razao_social, [Rua] = @Rua, [Numero] = @Numero, [Bairro] = @Bairro, [Cidade] = @Cidade, [Complemento] = @Complemento, [Cep] = @Cep, [Telefone] = @Telefone, [Celular] = @Celular WHERE (([Id] = @Original_Id) AND ([Nome] = @Original_Nome) AND ([Email] = @Original_Email) AND ([TipoPessoa] = @Original_TipoPessoa) AND ([Cpf_cnpj] = @Original_Cpf_cnpj) AND ([Razao_social] = @Original_Razao_social) AND ([Rua] = @Original_Rua) AND ([Numero] = @Original_Numero) AND ([Bairro] = @Original_Bairro) AND ([Cidade] = @Original_Cidade) AND ([Complemento] = @Original_Complemento) AND ([Cep] = @Original_Cep) AND ([Telefone] = @Original_Telefone) AND ([Celular] = @Original_Celular));
SELECT Id, Nome, Email, TipoPessoa, Cpf_cnpj, Razao_social, Rua, Numero, Bairro, Cidade, Complemento, Cep, Telefone, Celular FROM Fornecedor WHERE (Id = @Id)";
        ...
        private void InitConnection() {
            ...
            this._connection.ConnectionString = global::Apresentacao.Properties.Settings.Default.Database1ConnectionString;
        }
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0].CommandText = "SELECT Id, Nome, Email, TipoPessoa, Cpf_cnpj, Razao_social, Rua, Numero, Bairro, " +
                "Cidade, Complemento, Cep, Telefone, Celular FROM dbo.Fornecedor";
        ...
        public virtual int Fill(Database1DataSet.FornecedorDataTable dataTable) {
        ...
        public virtual Database1DataSet.FornecedorDataTable GetData() {
            this.Adapter.SelectCommand = this.CommandCollection[0];
            Database1DataSet.FornecedorDataTable dataTable = new Database1DataSet.FornecedorDataTable();
        ...
        [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "17.0.0.0")]
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        public virtual int Update(Database1DataSet.FornecedorDataTable dataTable) {
        ...
        public virtual int Delete(int Original_Id, string Original_Nome, string Original_Email, int Original_TipoPessoa, string Original_Cpf_cnpj, string Original_Razao_social, string Original_Rua, int Original_Numero, string Original_Bairro, string Original_Cidade, string Original_Complemento, string Original_Cep, string Original_Telefone, string Original_Celular) {
            ...
            this.Adapter.DeleteCommand.Parameters[3].Value = ((int)(Original_TipoPessoa));
        ...
        public virtual int Insert(string Nome, string Email, int TipoPessoa, string Cpf_cnpj, string Razao_social, string Rua, int Numero, string Bairro, string Cidade, string Complemento, string Cep, string Telefone, string Celular) {
            if ((Nome == null)) {
            ...
            this.Adapter.InsertCommand.Parameters[2].Value = ((int)(TipoPessoa));
            if ((Cpf_cnpj == null)) {
        ...
        public virtual int Update(
            ...
            this.Adapter.UpdateCommand.Parameters[2].Value = ((int)(TipoPessoa));
            if ((Cpf_cnpj == null)) {
                throw new global::System.ArgumentNullException("Cpf_cnpj");
            }
            else {
            ...
            this.Adapter.UpdateCommand.Parameters[16].Value = ((int)(Original_TipoPessoa));
            if ((Original_Cpf_cnpj == null)) {
                throw new global::System.ArgumentNullException("Original_Cpf_cnpj");
            }
            else {
        ...
        public virtual int Update(
                    ...
                    string Original_Telefone, 
                    string Original_Celular) {
            return this.Update(Nome, Email, TipoPessoa, Cpf_cnpj, Razao_social, Rua, Numero, Bairro, Cidade, Complemento, Cep, Telefone, Celular, Original_Id, Original_Nome, Original_Email, Original_TipoPessoa, Original_Cpf_cnpj, Original_Razao_social, Original_Rua, Original_Numero, Original_Bairro, Original_Cidade, Original_Complemento, Original_Cep, Original_Telefone, Original_Celular, Original_Id);
        }
    }
